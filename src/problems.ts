...
export const PROBLEMS: Problem[] = [
  ...
  problem('General Arithmetic–Geometric Mean', '1/n sum_(k=1)^n x_k >= root(n, product_(k=1)^n x_k)', 22),
  ...
  problem('Forcing Modus Ponens', 'p forces phi and p forces (phi ==> psi) ==> p forces psi', 28),
  ...
  problem('Isodiametric Inequality', 'op("area")(Omega) <= (pi op("diam") #h(0pt) (Omega)^2) / 4', 24),
  ...
  problem('Lorentz Force Law', 'bold(F) = q (bold(E) + bold(v) times bold(B))', 18),
  problem('Charge Continuity Equation', '(partial rho)/(partial t) + nabla dot bold(J) = 0', 22),
  problem('Poynting Vector', 'bold(S) = 1/mu_0 bold(E) times bold(B)', 18),
